def english_num number
	...
	if number < 0
		return "Please enter a number Zero or greater (up to 100)."
	elsif number > 100
		return "Please enter a number 100 or less (0)."
	end

	num_string = '' # this is the string we will return
	#left is unprocessed
	#write is the part we output
